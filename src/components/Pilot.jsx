...
function Pilot() {
  return (
    ...
    >
      <h1
        className="drop-shadow-md w-3/4 text-[43px] leading-[43px] sm:leading-[50px] sm:text-[55px] md:text-[65px] md:leading-[60px] lg:text-[85px] lg:leading-[80px] xl:leading-[90px] xl:text-[90px] 2xl:text-[100px] 2xl:leading-[100px] xl:w-3/4 text-center md:mt-2 lg:mt-4 lg:w-3/4
      ...
      <div className="mt-0 px-3 md:px-6">
        <video
          ...
          poster={Poster}
        >
          <source src={PilotVid} alt="Black Girl Sparkle Pilot Episode" type="video/mp4" />
        </video>
      </div>
